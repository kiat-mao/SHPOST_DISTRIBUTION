...
RSpec.describe OrderDetailsController, type: :controller do
  ...
  # OrderDetailsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested order_detail as @order_detail" do
      order_detail = OrderDetail.create! valid_attributes
      get :show, {:id => order_detail.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested order_detail as @order_detail" do
      order_detail = OrderDetail.create! valid_attributes
      get :edit, {:id => order_detail.to_param}, valid_session
      expect(assigns(:order_detail)).to eq(order_detail)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new OrderDetail" do
        expect {
          post :create, {:order_detail => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved order_detail as @order_detail" do
        post :create, {:order_detail => invalid_attributes}, valid_session
        expect(assigns(:order_detail)).to be_a_new(OrderDetail)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested order_detail" do
        order_detail = OrderDetail.create! valid_attributes
        put :update, {:id => order_detail.to_param, :order_detail => new_attributes}, valid_session
        order_detail.reload
      ...
      it "assigns the requested order_detail as @order_detail" do
        order_detail = OrderDetail.create! valid_attributes
        put :update, {:id => order_detail.to_param, :order_detail => valid_attributes}, valid_session
        expect(assigns(:order_detail)).to eq(order_detail)
      end
    ...
    context "with invalid params" do
      it "assigns the order_detail as @order_detail" do
        order_detail = OrderDetail.create! valid_attributes
        put :update, {:id => order_detail.to_param, :order_detail => invalid_attributes}, valid_session
        expect(assigns(:order_detail)).to eq(order_detail)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested order_detail" do
      order_detail = OrderDetail.create! valid_attributes
      expect {
        delete :destroy, {:id => order_detail.to_param}, valid_session
      }.to change(OrderDetail, :count).by(-1)
    end
